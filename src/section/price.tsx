    ...
    <>
      ...
      <div className="flex flex-row flex-wrap">
        <CardLink animated={true} href="#contact" image="apartment-green.svg" alt="price-apartment" title="Mieszkanie"
                  htmlText={[
                    <div key="price-apartment-price" className="font-medium text-xl my-2">Od 290 zł brutto</div>,
        ...
        <CardLink animated={true} href="#contact" image="home-green.svg" alt="price-home" title="Dom"
                  htmlText={[
                    <div key="price-home-price" className="font-medium text-xl my-2">Od 490 zł brutto</div>,
        ...
        <CardLink animated={true} href="#contact" image="house-day-green.svg" alt="price-premises"
                  ...
                  htmlText={[
                    <div key="price-premises-price" className="font-medium text-xl my-2">Od 490 zł brutto</div>,
        ...
        <CardLink animated={true} href="#contact" image="industry-windows-green.svg" alt="price-industry"
                  title="Inny budynek"
                  htmlText={[
                    <div key="price-industry-price" className="font-medium text-xl my-2">Od 590 zł brutto</div>,
